...
def get_crt(account_key, csr, acme_dir, contact, verifychallenge, log=LOGGER, CA=DEFAULT_CA):
...
def main(argv):
    ...
    signed_crt = get_crt(args.account_key, args.csr, args.acme_dir, args.contact, verifychallenge=args.verifychallenge, log=LOGGER, CA=args.ca)
